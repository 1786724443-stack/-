...
public class FortuneCardLabel extends JLabel {
    ...
    private void drawMajorArcanaSymbol(Graphics2D g, int cx, int cy, int size, int index, Color gold, Color darkPurple, int margin) {
        ...
        switch (index) {
            case 0: drawFool(g, cx, cy, half, gold, darkPurple); break;
            case 1: drawMagician(g, cx, cy, half, gold, darkPurple); break;
            case 2: drawHighPriestess(g, cx, cy, half, gold, darkPurple); break;
            case 3: drawEmpress(g, cx, cy, half, gold, darkPurple); break;
            case 4: drawEmperor(g, cx, cy, half, gold, darkPurple); break;
            case 5: drawHierophant(g, cx, cy, half, gold, darkPurple); break;
            case 6: drawLovers(g, cx, cy, half, gold, darkPurple); break;
            case 7: drawChariot(g, cx, cy, half, gold, darkPurple); break;
            case 8: drawStrength(g, cx, cy, half, gold, darkPurple); break;
            case 9: drawHermit(g, cx, cy, half, gold, darkPurple); break;
            case 10: drawWheelOfFortune(g, cx, cy, half, gold, darkPurple); break;
            case 11: drawJustice(g, cx, cy, half, gold, darkPurple); break;
            case 12: drawHangedMan(g, cx, cy, half, gold, darkPurple); break;
            case 13: drawDeath(g, cx, cy, half, gold, darkPurple); break;
            case 14: drawTemperance(g, cx, cy, half, gold, darkPurple); break;
            case 15: drawDevil(g, cx, cy, half, gold, darkPurple); break;
            case 16: drawTower(g, cx, cy, half, gold, darkPurple); break;
            case 17: drawStar(g, cx, cy, half, gold, darkPurple); break;
            case 18: drawMoon(g, cx, cy, half, gold, darkPurple); break;
            case 19: drawSun(g, cx, cy, half, gold, darkPurple); break;
            case 20: drawJudgement(g, cx, cy, half, gold, darkPurple); break;
            case 21: drawWorld(g, cx, cy, half, gold, darkPurple); break;
        }
    }
